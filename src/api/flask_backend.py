...
from src.controllers.simple_multiagent_controller import SimpleMultiAgentController  # Educational controller
from src.core.research_interface import get_research_interface
from src.core.config_manager import get_config_manager, ExperimentConfig, AgentConfig, EnvironmentConfig, TrainingConfig  # Research features
    ...
    try:
        ...
        def training_worker():
            try:
                ...
                device = torch.device('cuda' if torch.cuda.is_available() and utils_config.get('device') != 'cpu' else 'cpu')
